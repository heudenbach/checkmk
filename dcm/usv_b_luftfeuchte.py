...
def discover_usv_b_luftfeuchte(section):
    yield Service()

def check_usv_b_luftfeuchte(section):
...
register.check_plugin(
    name = "usv_b_luftfeuchte",
    service_name = "USV-B Luftfeuchtigkeit",
    discovery_function = discover_usv_b_luftfeuchte,
    check_function = check_usv_b_luftfeuchte,
)
