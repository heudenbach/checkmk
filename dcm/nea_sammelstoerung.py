...
def discover_nea_sammelst(section):
    yield Service()

def check_nea_sammelst(section):
...
register.check_plugin(
    name = "nea_sammelst",
    service_name = "NEA Sammelstörung",
    discovery_function = discover_nea_sammelst,
    check_function = check_nea_sammelst,
)
