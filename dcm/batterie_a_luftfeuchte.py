...
def discover_batterie_a_luftfeuchte(section):
    yield Service()

def check_batterie_a_luftfeuchte(section):
...
register.check_plugin(
    name = "batterie_a_luftfeuchte",
    service_name = "Batterie-A Luftfeuchtigkeit",
    discovery_function = discover_batterie_a_luftfeuchte,
    check_function = check_batterie_a_luftfeuchte,
)
...
register.snmp_section(
    ...
    exists(".1.3.6.1.3.1.0.25")
        ...
        base = '.1.3.6.1.3.1.10',
        oids = [
            '7.0',    # Batterie-A Luftfeuchtigkeit
        ],
    ),
)