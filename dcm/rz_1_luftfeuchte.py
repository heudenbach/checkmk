...
def discover_rz_1_luftfeuchte(section):
    yield Service()

def check_rz_1_luftfeuchte(section):
...
register.check_plugin(
    name = "rz_1_luftfeuchte",
    service_name = "RZ 1 Luftfeuchtigkeit",
    discovery_function = discover_rz_1_luftfeuchte,
    check_function = check_rz_1_luftfeuchte,
)
