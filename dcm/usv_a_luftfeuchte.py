...
def discover_usv_a_luftfeuchte(section):
    yield Service()

def check_usv_a_luftfeuchte(section):
...
register.check_plugin(
    name = "usv_a_luftfeuchte",
    service_name = "USV-A Luftfeuchtigkeit",
    discovery_function = discover_usv_a_luftfeuchte,
    check_function = check_usv_a_luftfeuchte,
)
