...
def discover_nshv_a_luftfeuchte(section):
    yield Service()

def check_nshv_a_luftfeuchte(section):
...
register.check_plugin(
    name = "nshv_a_luftfeuchte",
    service_name = "NSHV-A Luftfeuchtigkeit ",
    discovery_function = discover_nshv_a_luftfeuchte,
    check_function = check_nshv_a_luftfeuchte,
)
