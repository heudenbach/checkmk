...
def discover_usv_b_sammelstoerung(section):
    yield Service()

def check_usv_b_sammelstoerung(section):
...
register.check_plugin(
    name = "usv_b_sammelstoerung",
    service_name = "USV-B Sammelstörung",
    discovery_function = discover_usv_b_sammelstoerung,
    check_function = check_usv_b_sammelstoerung,
)
