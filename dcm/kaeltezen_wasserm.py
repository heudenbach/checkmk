...
def discover_kaeltez_wasserm(section):
    yield Service()

def check_kaeltez_wasserm(section):
...
register.check_plugin(
    name = "kaeltez_wasserm",
    service_name = "Kältezentrale Wassermelder",
    discovery_function = discover_kaeltez_wasserm,
    check_function = check_kaeltez_wasserm,
)
...
register.snmp_section(
    ...
    exists(".1.3.6.1.3.1.0.25")
        ...
        base = '.1.3.6.1.3.1',
        oids = [
            '5.0',    # Kältezentrale Wassermelder
        ],
    ),
)