...
def discover_uv_usv_b_wasserm(section):
    yield Service()

def check_uv_usv_b_wasserm(section):
...
register.check_plugin(
    name = "uv_usv_b_wasserm",
    service_name = "UV-USV-B Wassermelder",
    discovery_function = discover_uv_usv_b_wasserm,
    check_function = check_uv_usv_b_wasserm,
)
