...
def discover_uv_usv_a_wasserm(section):
    yield Service()

def check_uv_usv_a_wasserm(section):
...
register.check_plugin(
    name = "uv_usv_a_wasserm",
    service_name = "UV-USV-A Wassermelder",
    discovery_function = discover_uv_usv_a_wasserm,
    check_function = check_uv_usv_a_wasserm,
)
