...
def discover_loeschanlage_wasserm(section):
    yield Service()

def check_loeschanlage_wasserm(section):
...
register.check_plugin(
    name = "loeschanlage_wasserm",
    service_name = "Löschanlage Wassermelder",
    discovery_function = discover_loeschanlage_wasserm,
    check_function = check_loeschanlage_wasserm,
)
