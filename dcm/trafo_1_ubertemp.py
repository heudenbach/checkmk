...
def discover_trafo_1_ubertemp(section):
    yield Service()

def check_trafo_1_ubertemp(section):
...
register.check_plugin(
    name = "trafo_1_ubertemp",
    service_name = "Trafo 1 - Übertemperatur",
    discovery_function = discover_trafo_1_ubertemp,
    check_function = check_trafo_1_ubertemp,
)
