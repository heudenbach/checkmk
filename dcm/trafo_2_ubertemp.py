...
def discover_trafo_2_ubertemp(section):
    yield Service()

def check_trafo_2_ubertemp(section):
...
register.check_plugin(
    name = "trafo_2_ubertemp",
    service_name = "Trafo 2 - Übertemperatur",
    discovery_function = discover_trafo_2_ubertemp,
    check_function = check_trafo_2_ubertemp,
)
