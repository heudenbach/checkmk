...
def discover_sicherheitsr_luftfeuchte(section):
    yield Service()

def check_sicherheitsr_luftfeuchte(section):
...
register.check_plugin(
    name = "sicherheitsr_luftfeuchte",
    service_name = "Sicherheitsraum Luftfeuchtigkeit",
    discovery_function = discover_sicherheitsr_luftfeuchte,
    check_function = check_sicherheitsr_luftfeuchte,
)
...
register.snmp_section(
    ...
    exists(".1.3.6.1.3.1.0.25")
        ...
        base = '.1.3.6.1.3.1.1',
        oids = [
            '1.0',    # Sicherheitsraum Luftfeuchtigkeit
        ],
    ),
)