...
def discover_flur_wasserm(section):
    yield Service()

def check_flur_wasserm(section):
...
register.check_plugin(
    name = "flur_wasserm",
    service_name = "Flur Wassermelder",
    discovery_function = discover_flur_wasserm,
    check_function = check_flur_wasserm,
)
