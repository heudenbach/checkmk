...
def discover_monitoring_wasserm(section):
    yield Service()

def check_monitoring_wasserm(section):
...
register.check_plugin(
    name = "monitoring_wasserm",
    service_name = "Monitoring Wassermelder",
    discovery_function = discover_monitoring_wasserm,
    check_function = check_monitoring_wasserm,
)
