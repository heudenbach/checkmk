...
def discover_ukg_4_stoerung(section):
    yield Service()

def check_ukg_4_stoerung(section):
...
register.check_plugin(
    name = "ukg_4_stoerung",
    service_name = "UKG 4 Sammelstörung",
    discovery_function = discover_ukg_4_stoerung,
    check_function = check_ukg_4_stoerung,
)
