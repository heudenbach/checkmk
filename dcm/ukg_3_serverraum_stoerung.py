...
def discover_ukg_3_stoerung(section):
    yield Service()

def check_ukg_3_stoerung(section):
...
register.check_plugin(
    name = "ukg_3_stoerung",
    service_name = "UKG 3 Sammelstörung",
    discovery_function = discover_ukg_3_stoerung,
    check_function = check_ukg_3_stoerung,
)
